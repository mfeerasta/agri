...
type ServerResult = { ok: true; id: string } | { ok: false; error: string };

export async function submitDieselPurchase(raw: unknown): Promise<ServerResult> {
...
export async function submitDieselDailyLog(raw: unknown): Promise<ServerResult> {

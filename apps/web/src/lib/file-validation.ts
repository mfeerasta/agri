/**
 * Magic-number based MIME validation. Never trust the client-supplied
 * Content-Type. Reads the first bytes of an uploaded blob and matches
...
export const DOCUMENT_MIMES = [...PHOTO_MIMES, 'application/pdf'];
